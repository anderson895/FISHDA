...
public class UserBuyHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_buy_history);
        ...
        itemsRef = FirebaseDatabase.getInstance().getReference("buy").child(userId);
        ...
        itemsRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot itemSnapshot : dataSnapshot.getChildren()) {
                    ...
                    String buyPrice = itemSnapshot.child("buyPrice").getValue(String.class); // Removed unnecessary casting
                    ...
                    String buyUserID = itemSnapshot.child("buyUserID").getValue(String.class);
                ...
                if (dataList.isEmpty()) {
                    ...
                    Toast.makeText(UserBuyHistory.this, "No data available", Toast.LENGTH_SHORT).show();
                }
            }
